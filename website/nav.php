...
<!-- Fallback: Show all hidden elements when JavaScript is disabled -->
<noscript>
    <style>
        .reveal-init { opacity: 1 !important; transform: none !important; }
        .ambient__float { display: none !important; }
    </style>
</noscript>
...
<!-- Hidden Google Translate Element Container (lazy-loaded by nav.js) -->
