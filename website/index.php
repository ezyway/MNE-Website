...
<head>
	...
	<meta name="description" content="Maruti Nandan Exports is a premier Indian exporter of whole spices, grounded spices, grains, pulses, dry fruits, and gourmet makhana, delivering certified quality to 25+ countries worldwide.">
	<meta name="keywords" content="Spices Export, Indian Spices, Basmati Rice Export, Pulses Export, Makhana Exporter, Dry Fruits India, Maruti Nandan Exports, APEDA Certified Exporter">
	<meta name="author" content="Maruti Nandan Exports">
	
	<!-- Open Graph Meta Tags -->
	<meta property="og:title" content="Maruti Nandan Exports | Premium Indian Agricultural & Spice Exports">
	<meta property="og:description" content="Sourcing, grading and shipping premium Indian spices, grains, pulses, and dry fruits to 25+ countries worldwide.">
	<meta property="og:type" content="website">
	<meta property="og:image" content="assets/logo.png">

	<!-- Document Title -->
	<title>Maruti Nandan Exports | Premium Indian Spices, Grains & Agro Exports</title>
...
<body class="home">
		...
		<div class="hero__card glass-panel">
			<div class="hero__badge-wrapper">
				<span class="eyebrow">
					...
					APEDA &amp; FSSAI Certified • Government Recognized
				</span>
			</div>
			
			<h1 class="hero__title">
				Pure Indian Harvest.<br>
				<em>World-Class Global Exports.</em>
			</h1>
			
			<p class="hero__text">
				From the fertile agricultural heartlands of India to <strong>25+ countries worldwide</strong>. Sourcing, sorting, grading, and shipping premium spices, grains, pulses, dry fruits, and gourmet makhana with uncompromising quality and maritime reliability.
			</p>
			
			<!-- Actions -->
			<div class="hero__actions">
				<a href="products.php?category=all" class="btn btn-primary hero__btn">
				...
				<a href="contact.php" class="btn btn-ghost hero__btn">
					<span>Request Container Quote</span>
				</a>
			</div>

			<!-- Live Export Stats Ribbon -->
			<div class="hero__stats">
				<div class="hero__stat-item">
					<span class="hero__stat-num">25+</span>
					<span class="hero__stat-lbl">Global Destinations</span>
				</div>
				<div class="hero__stat-divider" aria-hidden="true"></div>
				<div class="hero__stat-item">
					<span class="hero__stat-num">100%</span>
					<span class="hero__stat-lbl">Quality Graded</span>
				</div>
				<div class="hero__stat-divider" aria-hidden="true"></div>
				<div class="hero__stat-item">
					<span class="hero__stat-num">50+</span>
					<span class="hero__stat-lbl">Agro Commodities</span>
				</div>
				<div class="hero__stat-divider" aria-hidden="true"></div>
				<div class="hero__stat-item">
					<span class="hero__stat-num">24/7</span>
					<span class="hero__stat-lbl">Rapid Trade Desk</span>
				</div>
			</div>
		</div>
	</header>
	...
	<!-- ===================================================
         About Story Spotlight Section
         =================================================== -->
	<section class="about-spotlight reveal-init" aria-label="Company Overview">
		<div class="about-spotlight__card glass-panel">
			<div class="about-spotlight__grid">
				
				<div class="about-spotlight__content">
					<span class="eyebrow">Our Heritage &amp; Purpose</span>
					<h2 class="about-spotlight__title">Delivering India's Richest Harvest to International Markets</h2>
					<p class="about-spotlight__lead">
						At <strong>Maruti Nandan Exports</strong>, we believe global trade is built on trust, impeccable quality consistency, and transparent communication.
					</p>
					<p class="about-spotlight__body">
						Headquartered in the trade gateway of Jamnagar, Gujarat, we bridge traditional Indian farming communities with international food processors, supermarket chains, and commodity importers. Our dedicated export desk ensures swift documentation, phytosanitary certifications, and customized cargo solutions.
					</p>
					
					<div class="about-spotlight__actions">
						<a href="about.php" class="btn btn-primary">
							<span>Read Full Company Story</span>
							<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
						</a>
						<a href="contact.php" class="btn btn-secondary">Contact Trade Desk</a>
					</div>
				</div>
	...
	<!-- ===================================================
         Call to Action Banner (B2B Trade Inquiries)
         =================================================== -->
	<section class="cta-banner reveal-init" aria-label="Trade Inquiry">
		<div class="cta-banner__card glass-panel">
			...
			<div class="cta-banner__content">
				...
				<h2 class="cta-banner__title">Request a Competitive FOB / CIF Quotation Today</h2>
				<p class="cta-banner__text">
					Contact our international export specialists for customized container quotations, product grade specification sheets, and sample dispatch.
				</p>
